...
public:
    ...
    void notify_instruction_start(  // NOLINT(misc-no-recursion)
        uint32_t pc, const StackTop& stack_top, int stack_height, int64_t gas,
...
private:
    ...
    virtual void on_instruction_start(uint32_t pc, const StackTop& stack_top, int stack_height,
