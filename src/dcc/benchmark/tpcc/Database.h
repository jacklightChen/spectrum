...
#include <dcc/benchmark/tpcc/Schema.h>
...
class Database {
 public:
  ...
  void initialize(Context &context) {
    ...
    //       TableFactory::create_table<997, order_line::key,
    //       order_line::value>(
 ...
 private:
  void warehouseInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void districtInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void customerInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void customerNameIdxInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void historyInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void newOrderInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void orderInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void orderLineInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void itemInit(Context &context, std::size_t partitionID) {
    Random random;
  ...
  void stockInit(Context &context, std::size_t partitionID) {
    Random random;
