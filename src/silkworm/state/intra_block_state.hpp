...
class IntraBlockState {
  public:
    ...
    FlatHashMap<evmc::address, state::Storage>& get_storage_instance() { return storage_; }
    ...
    // HZC tmp add
    evmc::bytes32 get_storage_with_local(const evmc::address& address, const evmc::bytes32& key, bool original, const Transaction* txn) noexcept;
