            ...
            for cc in protocols:
                ...
                try:
                    ...
                    df.loc[len(df)] = {
                        ...
                        'commit': sum_commit / repeat,
                        'abort': (sum_execution - sum_commit) / repeat,
                        'latency_50': sum_latency_50 / repeat,
                        'latency_75': sum_latency_75 / repeat,
                        'latency_95': sum_latency_95 / repeat,
                        'latency_99': sum_latency_99 / repeat,
                    }
